"""
Variasi Request Rate — Rate 18 req/s
=====================================
Bagian dari Gap 6a: Stabilitas LTP-CPS di berbagai traffic load
REQ_RATE : 18 req/s (traffic sedang-tinggi)
Cache    : 10% dan 20% (fixed)
Topologi : TISCALI + GEANT
Zipf α   : 0.8 dan 1.0
Replikasi: 15

Jalankan: python -m icarus run config_rate18.py
...
REQ_RATE            = 18.0         # ← traffic sedang-tinggi
    ...
    for strategy in STRATEGIES:
        for topology in TOPOLOGIES:
            for network_cache in NETWORK_CACHE:
                ...
                experiment["desc"] = "rate=18 | Zipf={} | {} | topo={} | cache={}".format(
