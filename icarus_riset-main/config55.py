"""
Skenario 2 — Variasi Bobot LTP-CPS: w_t=0.5, w_p=0.5
========================================================
Seimbang — bobot BC dan popularitas sama besar

Jalankan: python -m icarus run --results hasil_bobot55.pickle config_bobot55.py
...
STRATEGIES = ["LCE", "LCD", "CL4M", "PROB_CACHE", "MCDM", "LTP_CPS_5_5"]
    ...
    for strategy in STRATEGIES:
        for topology in TOPOLOGIES:
            for network_cache in NETWORK_CACHE:
                ...
                experiment["desc"] = "S2 | w_t=0.5 w_p=0.5 | Zipf={} | {} | cache={}".format(
