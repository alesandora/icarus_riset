"""
Variasi Request Rate — Rate 12 req/s
=====================================
Bagian dari Gap 6a: Stabilitas LTP-CPS di berbagai traffic load
REQ_RATE : 12 req/s (baseline — sesuai paper C3CPS)
Cache    : 10% dan 20% (fixed)
Topologi : TISCALI + GEANT
Zipf α   : 0.8 dan 1.0
Replikasi: 15

Jalankan: python -m icarus run config_rate12.py
...
REQ_RATE            = 12.0         # ← baseline paper C3CPS
    ...
    for strategy in STRATEGIES:
        for topology in TOPOLOGIES:
            for network_cache in NETWORK_CACHE:
                ...
                experiment["desc"] = "rate=12 | Zipf={} | {} | topo={} | cache={}".format(
